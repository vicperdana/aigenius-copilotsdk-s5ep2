...
///     dotnet run --project src/AgentOrchestrator/samples/SdkLabs -- codealong-final --phase 1
///
...
///
/// This is the PARACHUTE — every phase is complete and verified.
/// Look for:   // 🪂 FINAL — DO NOT EDIT
/// Everything else is scaffolding. Fall back to CodeAlongFinal at any time.
/// </summary>
public static class CodeAlongFinal
{
    ...
    // 🪂 FINAL — DO NOT EDIT — the method + both [Description] attributes ──────────
    ...
    private static async Task<int> Phase5McpAsync(string? requestedModelId)
    {
        ...
        // 🪂 FINAL — DO NOT EDIT — the McpServers block is the payload ─────────────
    ...
    private static int PhaseUsage()
    {
        Console.WriteLine("""
            Usage:
              dotnet run --project src/AgentOrchestrator/samples/SdkLabs -- codealong-final --phase <1-5>
